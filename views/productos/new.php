        ...
        <div class="flex flex-col bg-white px-6 py-8 rounded-lg shadow-md">
            ...
            <div class="flex flex-col md:flex-row">
                ...
                <div class="md:w-3/12 md:mr-3">
                    <input_ type="text" placeholder="Codigo"></input_>
                </div>
                <div class="md:w-2/12">
                    <input_ type="text" placeholder="Stock"></input_>
                </div>
            </div>
            <!-- Segunda Fila -->
            <div class="flex flex-col md:flex-row mt-5">
                <div class="md:w-3/12 md:mr-3">
                    ...
                    <select class="bg-white pr-2 border border-gray-300 text-gray-900 sm:text-base rounded-lg focus:outline-none focus:border-cyan-600 focus:ring-cyan-600 focus:ring-2 block w-full p-2.5">
                ...
                <div class="md:w-3/12 md:mr-3">
                    ...
                    <input_ type="text" placeholder="23.00"></input_>
                </div>
                <div class="md:w-3/12 md:mr-3">
                    <label_>IGV</label_>
                    <input_ type="text" placeholder="Codigo"></input_>
            ...
            <div class="flex justify-end mt-5">
                <button_ color="cyan"><i class="fa fa-save pr-1"></i> Guardar</button_>
            </div>
        </div>
    </div>
</div>
